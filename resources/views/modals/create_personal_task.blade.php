    ...
    <div class="modal-content" style="max-width: 600px;">
        ...
        <div class="modal-body">
            <form id="createPersonalTaskForm">
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 12px; font-weight: 600; color: var(--text-primary);">Thể loại *</label>
                ...
                <div class="modal" id="createCategoryModal" style="z-index: 10001;">
                    <div class="modal-content" style="max-width: 400px;">
                        ...
                        <div class="modal-body">
                            <div style="margin-bottom: 20px;">
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--text-primary);">Tên thể loại *</label>
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--text-primary);">Thời gian thông báo (tùy chọn)</label>
